...
$arecorderbutton = $renderer->js_trigger_button('listaudiorecstart', true, get_string('listrecaudiolabel',constants::M_LANG));
...
$opts=array('modulecssclass'=>constants::M_CLASS, 'cmid'=>$cm->id);
