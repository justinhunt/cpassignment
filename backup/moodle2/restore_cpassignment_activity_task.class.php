...
require_once($CFG->dirroot . '/mod/cpassignment/backup/moodle2/restore_cpassignment_stepslib.php'); // Because it exists (must)

/**
 * cpassignment restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_cpassignment_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
		...
		$contents[] = new restore_decode_content(constants::M_MODNAME,
                          array('finished'), constants::M_MODNAME);
