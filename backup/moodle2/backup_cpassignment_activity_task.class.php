...
/**
 * Defines {@link backup_cpassignment_activity_task} class
 *
...
require_once($CFG->dirroot . '/mod/cpassignment/backup/moodle2/backup_cpassignment_stepslib.php');

/**
 * Provides all the settings and steps to perform one complete backup of cpassignment activity
 */
class backup_cpassignment_activity_task extends backup_activity_task {
